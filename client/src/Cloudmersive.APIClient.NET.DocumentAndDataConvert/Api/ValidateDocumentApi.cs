...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Api
{
    ...
    public partial class ValidateDocumentApi : IValidateDocumentApi
    {
        ...
        /// <returns></returns>
        public ValidateDocumentApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< DocumentValidationResult > ValidateDocumentDocxValidationWithHttpInfo (System.IO.Stream inputFile)
        {
            ...
            return new ApiResponse<DocumentValidationResult>(localVarStatusCode,
                ...
                (DocumentValidationResult) Configuration.ApiClient.Deserialize(localVarResponse, typeof(DocumentValidationResult)));
        }
