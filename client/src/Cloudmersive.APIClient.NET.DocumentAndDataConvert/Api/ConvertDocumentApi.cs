...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Api
{
    ...
    public partial class ConvertDocumentApi : IConvertDocumentApi
    {
        ...
        /// <returns></returns>
        public ConvertDocumentApi(Cloudmersive.APIClient.NET.DocumentAndDataConvert.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Convert Document to PDF Automatically detect file type and convert it to PDF.  Supports all of the major Office document file formats, over 100 image formats, and even multi-page TIFF files.
        /// </summary>
        /// <exception cref="Cloudmersive.APIClient.NET.DocumentAndDataConvert.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inputFile">Input file to perform the operation on.</param>
        /// <returns>byte[]</returns>
