...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Api
{
    ...
    public interface IConvertWebApi : IApiAccessor
    {
        ...
        /// <param name="inputRequest">HTML input to convert to DOCX</param>
    ...
    public partial class ConvertWebApi : IConvertWebApi
    {
        ...
        /// <returns></returns>
        public ConvertWebApi(Cloudmersive.APIClient.NET.DocumentAndDataConvert.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< byte[] > ConvertWebHtmlToDocxWithHttpInfo (HtmlToOfficeRequest inputRequest)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(inputRequest); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse< HtmlToTextResponse > ConvertWebHtmlToTxtWithHttpInfo (HtmlToTextRequest input)
        {
            ...
            return new ApiResponse<HtmlToTextResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (HtmlToTextResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(HtmlToTextResponse)));
        }
        ...
        public ApiResponse< HtmlMdResult > ConvertWebMdToHtmlWithHttpInfo (System.IO.Stream inputFile)
        {
            ...
            return new ApiResponse<HtmlMdResult>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (HtmlMdResult) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(HtmlMdResult)));
        }
        ...
        public ApiResponse< UrlToTextResponse > ConvertWebUrlToTxtWithHttpInfo (UrlToTextRequest input)
        {
            ...
            return new ApiResponse<UrlToTextResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (UrlToTextResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UrlToTextResponse)));
        }
