...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Api
{
    ...
    public partial class ZipArchiveApi : IZipArchiveApi
    {
        ...
        /// <returns></returns>
        public ZipArchiveApi(Cloudmersive.APIClient.NET.DocumentAndDataConvert.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< Object > ZipArchiveZipCreateQuarantineWithHttpInfo (string password, System.IO.Stream inputFile1, string encryptionAlgorithm = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ZipArchiveZipCreateQuarantine", localVarResponse);
                if (exception != null) throw exception;
            }
