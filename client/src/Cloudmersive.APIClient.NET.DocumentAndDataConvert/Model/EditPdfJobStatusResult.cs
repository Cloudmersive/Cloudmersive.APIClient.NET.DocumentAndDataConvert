...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EditPdfJobStatusResult :  IEquatable<EditPdfJobStatusResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EditPdfJobStatusResult" /> class.
        /// </summary>
        ...
        public EditPdfJobStatusResult(bool? successful = default(bool?), string asyncJobStatus = default(string), string asyncJobID = default(string), byte[] outputFileResult = default(byte[]), string errorMessage = default(string))
        {
        ...
        {
            return this.Equals(input as EditPdfJobStatusResult);
        }

        /// <summary>
        /// Returns true if EditPdfJobStatusResult instances are equal
        /// </summary>
        /// <param name="input">Instance of EditPdfJobStatusResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditPdfJobStatusResult input)
        {
            if (input == null)
                return false;
