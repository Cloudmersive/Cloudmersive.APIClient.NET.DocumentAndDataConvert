...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutodetectToJpgResult :  IEquatable<AutodetectToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutodetectToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public AutodetectToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as AutodetectToJpgResult);
        }

        /// <summary>
        /// Returns true if AutodetectToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AutodetectToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutodetectToJpgResult input)
        {
            if (input == null)
                return false;
