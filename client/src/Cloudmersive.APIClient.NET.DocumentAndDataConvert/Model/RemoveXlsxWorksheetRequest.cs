...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveXlsxWorksheetRequest :  IEquatable<RemoveXlsxWorksheetRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Required; Worksheet (tab) within the spreadsheet to delete; leave blank to default to the first worksheet.  Use the Get Worksheets API to enumerate available worksheets in a spreadsheet.</value>
        [DataMember(Name="WorksheetToRemove", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorksheetToRemove: ").Append(WorksheetToRemove).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RemoveXlsxWorksheetRequest);
        }

        /// <summary>
        /// Returns true if RemoveXlsxWorksheetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveXlsxWorksheetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveXlsxWorksheetRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WorksheetToRemove == input.WorksheetToRemove ||
                    (this.WorksheetToRemove != null &&
                    this.WorksheetToRemove.Equals(input.WorksheetToRemove))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WorksheetToRemove != null)
                    hashCode = hashCode * 59 + this.WorksheetToRemove.GetHashCode();
                return hashCode;
            }
        }
