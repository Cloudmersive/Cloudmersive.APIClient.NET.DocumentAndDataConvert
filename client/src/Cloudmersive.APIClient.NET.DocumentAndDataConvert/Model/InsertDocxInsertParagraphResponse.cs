...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertDocxInsertParagraphResponse :  IEquatable<InsertDocxInsertParagraphResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertDocxInsertParagraphResponse" /> class.
        /// </summary>
        ...
        public InsertDocxInsertParagraphResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as InsertDocxInsertParagraphResponse);
        }

        /// <summary>
        /// Returns true if InsertDocxInsertParagraphResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertDocxInsertParagraphResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertDocxInsertParagraphResponse input)
        {
            if (input == null)
                return false;
