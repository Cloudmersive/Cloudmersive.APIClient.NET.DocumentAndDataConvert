...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteDocxTableRowRequest :  IEquatable<DeleteDocxTableRowRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDocxTableRowRequest" /> class.
        /// </summary>
        ...
        /// <param name="tableRowRowIndex">0-based index of the row to delete (e.g. 0, 1, 2, ...) in the table.</param>
        public DeleteDocxTableRowRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string), string tablePath = default(string), int? tableRowRowIndex = default(int?))
        {
        ...
        /// </summary>
        /// <value>0-based index of the row to delete (e.g. 0, 1, 2, ...) in the table</value>
        ...
        {
            return this.Equals(input as DeleteDocxTableRowRequest);
        }

        /// <summary>
        /// Returns true if DeleteDocxTableRowRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteDocxTableRowRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteDocxTableRowRequest input)
        {
            if (input == null)
                return false;
