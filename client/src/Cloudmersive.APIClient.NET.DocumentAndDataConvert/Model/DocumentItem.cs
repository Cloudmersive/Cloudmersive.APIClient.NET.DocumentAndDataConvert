...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    public partial class DocumentItem :  IEquatable<DocumentItem>, IValidatableObject
    {
        ...
        /// <param name="documentContent">Contents of the document as a binary byte array.</param>
        public DocumentItem(string documentFileName = default(string), byte[] documentContent = default(byte[]))
        {
        ...
        /// </summary>
        /// <value>Contents of the document as a binary byte array</value>
