...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClearXlsxRowResponse :  IEquatable<ClearXlsxRowResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearXlsxRowResponse" /> class.
        /// </summary>
        ...
        public ClearXlsxRowResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as ClearXlsxRowResponse);
        }

        /// <summary>
        /// Returns true if ClearXlsxRowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClearXlsxRowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClearXlsxRowResponse input)
        {
            if (input == null)
                return false;
