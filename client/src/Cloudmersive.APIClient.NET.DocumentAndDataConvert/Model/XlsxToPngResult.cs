...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XlsxToPngResult :  IEquatable<XlsxToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XlsxToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public XlsxToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as XlsxToPngResult);
        }

        /// <summary>
        /// Returns true if XlsxToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of XlsxToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XlsxToPngResult input)
        {
            if (input == null)
                return false;
