...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    public partial class InsertDocxInsertParagraphRequest :  IEquatable<InsertDocxInsertParagraphRequest>, IValidatableObject
    {
        ...
        [DataMember(Name="ParagraphToInsert", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ParagraphToInsert: ").Append(ParagraphToInsert).Append("\n");
        ...
        {
            return this.Equals(input as InsertDocxInsertParagraphRequest);
        }

        /// <summary>
        /// Returns true if InsertDocxInsertParagraphRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertDocxInsertParagraphRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertDocxInsertParagraphRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ParagraphToInsert == input.ParagraphToInsert ||
                    (this.ParagraphToInsert != null &&
                    this.ParagraphToInsert.Equals(input.ParagraphToInsert))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParagraphToInsert != null)
                    hashCode = hashCode * 59 + this.ParagraphToInsert.GetHashCode();
