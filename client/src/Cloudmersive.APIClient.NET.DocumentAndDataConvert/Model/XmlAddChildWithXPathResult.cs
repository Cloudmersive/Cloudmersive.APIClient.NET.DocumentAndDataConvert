...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    public partial class XmlAddChildWithXPathResult :  IEquatable<XmlAddChildWithXPathResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as XmlAddChildWithXPathResult);
        }

        /// <summary>
        /// Returns true if XmlAddChildWithXPathResult instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlAddChildWithXPathResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlAddChildWithXPathResult input)
        {
            if (input == null)
                return false;
