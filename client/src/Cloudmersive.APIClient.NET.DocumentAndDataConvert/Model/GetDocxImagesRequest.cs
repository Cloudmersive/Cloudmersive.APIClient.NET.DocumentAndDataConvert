...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxImagesRequest :  IEquatable<GetDocxImagesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxImagesRequest" /> class.
        /// </summary>
        ...
        public GetDocxImagesRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetDocxImagesRequest);
        }

        /// <summary>
        /// Returns true if GetDocxImagesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxImagesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxImagesRequest input)
        {
            if (input == null)
                return false;
