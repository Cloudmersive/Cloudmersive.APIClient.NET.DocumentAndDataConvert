...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocxSetFooterResponse :  IEquatable<DocxSetFooterResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocxSetFooterResponse" /> class.
        /// </summary>
        ...
        public DocxSetFooterResponse(bool? Successful = default(bool?), string EditedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as DocxSetFooterResponse);
        }

        /// <summary>
        /// Returns true if DocxSetFooterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DocxSetFooterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocxSetFooterResponse input)
        {
            if (input == null)
                return false;
