...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxGetCommentsRequest :  IEquatable<GetDocxGetCommentsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxGetCommentsRequest" /> class.
        /// </summary>
        ...
        public GetDocxGetCommentsRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetDocxGetCommentsRequest);
        }

        /// <summary>
        /// Returns true if GetDocxGetCommentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxGetCommentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxGetCommentsRequest input)
        {
            if (input == null)
                return false;
