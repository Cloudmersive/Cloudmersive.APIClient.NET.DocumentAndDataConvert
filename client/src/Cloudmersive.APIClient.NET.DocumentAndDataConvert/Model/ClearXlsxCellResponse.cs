...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClearXlsxCellResponse :  IEquatable<ClearXlsxCellResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearXlsxCellResponse" /> class.
        /// </summary>
        ...
        public ClearXlsxCellResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as ClearXlsxCellResponse);
        }

        /// <summary>
        /// Returns true if ClearXlsxCellResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClearXlsxCellResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClearXlsxCellResponse input)
        {
            if (input == null)
                return false;
