...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RtfToJpgResult :  IEquatable<RtfToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RtfToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public RtfToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as RtfToJpgResult);
        }

        /// <summary>
        /// Returns true if RtfToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RtfToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RtfToJpgResult input)
        {
            if (input == null)
                return false;
