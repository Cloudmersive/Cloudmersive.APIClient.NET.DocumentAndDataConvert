...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocxInsertImageResponse :  IEquatable<DocxInsertImageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocxInsertImageResponse" /> class.
        /// </summary>
        ...
        public DocxInsertImageResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as DocxInsertImageResponse);
        }

        /// <summary>
        /// Returns true if DocxInsertImageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DocxInsertImageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocxInsertImageResponse input)
        {
            if (input == null)
                return false;
