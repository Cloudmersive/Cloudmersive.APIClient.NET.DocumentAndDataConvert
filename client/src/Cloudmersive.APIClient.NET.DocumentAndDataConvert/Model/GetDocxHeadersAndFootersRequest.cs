...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxHeadersAndFootersRequest :  IEquatable<GetDocxHeadersAndFootersRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxHeadersAndFootersRequest" /> class.
        /// </summary>
        ...
        public GetDocxHeadersAndFootersRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetDocxHeadersAndFootersRequest);
        }

        /// <summary>
        /// Returns true if GetDocxHeadersAndFootersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxHeadersAndFootersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxHeadersAndFootersRequest input)
        {
            if (input == null)
                return false;
