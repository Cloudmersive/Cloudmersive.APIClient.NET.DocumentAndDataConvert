...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateDocxTableRowResponse :  IEquatable<UpdateDocxTableRowResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDocxTableRowResponse" /> class.
        /// </summary>
        ...
        public UpdateDocxTableRowResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateDocxTableRowResponse);
        }

        /// <summary>
        /// Returns true if UpdateDocxTableRowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDocxTableRowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDocxTableRowResponse input)
        {
            if (input == null)
                return false;
