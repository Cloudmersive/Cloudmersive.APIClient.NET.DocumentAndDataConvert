...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PptxToPngResult :  IEquatable<PptxToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PptxToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public PptxToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as PptxToPngResult);
        }

        /// <summary>
        /// Returns true if PptxToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PptxToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PptxToPngResult input)
        {
            if (input == null)
                return false;
