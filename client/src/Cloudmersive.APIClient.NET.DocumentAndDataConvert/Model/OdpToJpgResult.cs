...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OdpToJpgResult :  IEquatable<OdpToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OdpToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public OdpToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as OdpToJpgResult);
        }

        /// <summary>
        /// Returns true if OdpToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OdpToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OdpToJpgResult input)
        {
            if (input == null)
                return false;
