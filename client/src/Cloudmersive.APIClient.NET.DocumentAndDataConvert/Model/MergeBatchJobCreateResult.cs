...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MergeBatchJobCreateResult :  IEquatable<MergeBatchJobCreateResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MergeBatchJobCreateResult" /> class.
        /// </summary>
        ...
        public MergeBatchJobCreateResult(bool? successful = default(bool?), string asyncJobID = default(string))
        {
        ...
        {
            return this.Equals(input as MergeBatchJobCreateResult);
        }

        /// <summary>
        /// Returns true if MergeBatchJobCreateResult instances are equal
        /// </summary>
        /// <param name="input">Instance of MergeBatchJobCreateResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MergeBatchJobCreateResult input)
        {
            if (input == null)
                return false;
