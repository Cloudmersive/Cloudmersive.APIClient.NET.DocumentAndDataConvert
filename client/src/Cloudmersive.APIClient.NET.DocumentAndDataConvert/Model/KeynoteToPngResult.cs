...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeynoteToPngResult :  IEquatable<KeynoteToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeynoteToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public KeynoteToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as KeynoteToPngResult);
        }

        /// <summary>
        /// Returns true if KeynoteToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of KeynoteToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeynoteToPngResult input)
        {
            if (input == null)
                return false;
