...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteDocxTableRowResponse :  IEquatable<DeleteDocxTableRowResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDocxTableRowResponse" /> class.
        /// </summary>
        ...
        public DeleteDocxTableRowResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as DeleteDocxTableRowResponse);
        }

        /// <summary>
        /// Returns true if DeleteDocxTableRowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteDocxTableRowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteDocxTableRowResponse input)
        {
            if (input == null)
                return false;
