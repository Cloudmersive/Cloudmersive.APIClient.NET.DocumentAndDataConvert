...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveWhitespaceFromTextResponse :  IEquatable<RemoveWhitespaceFromTextResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveWhitespaceFromTextResponse" /> class.
        /// </summary>
        /// <param name="successful">True if successful, false otherwise.</param>
        /// <param name="textContentResult">Result of performing a remove whitespace from string operation.</param>
        public RemoveWhitespaceFromTextResponse(bool? successful = default(bool?), string textContentResult = default(string))
        {
        ...
        /// </summary>
        /// <value>Result of performing a remove whitespace from string operation</value>
        ...
        {
            return this.Equals(input as RemoveWhitespaceFromTextResponse);
        }

        /// <summary>
        /// Returns true if RemoveWhitespaceFromTextResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveWhitespaceFromTextResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveWhitespaceFromTextResponse input)
        {
            if (input == null)
                return false;
