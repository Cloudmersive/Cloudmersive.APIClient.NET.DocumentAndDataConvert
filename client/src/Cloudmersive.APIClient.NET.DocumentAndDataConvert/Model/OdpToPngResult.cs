...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OdpToPngResult :  IEquatable<OdpToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OdpToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public OdpToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as OdpToPngResult);
        }

        /// <summary>
        /// Returns true if OdpToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OdpToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OdpToPngResult input)
        {
            if (input == null)
                return false;
