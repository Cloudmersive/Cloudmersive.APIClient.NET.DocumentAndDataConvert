...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    public partial class DocumentValidationResult :  IEquatable<DocumentValidationResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DocumentValidationResult);
        }

        /// <summary>
        /// Returns true if DocumentValidationResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentValidationResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentValidationResult input)
        {
            if (input == null)
                return false;
