...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DisableSharedWorkbookRequest :  IEquatable<DisableSharedWorkbookRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableSharedWorkbookRequest" /> class.
        /// </summary>
        ...
        public DisableSharedWorkbookRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as DisableSharedWorkbookRequest);
        }

        /// <summary>
        /// Returns true if DisableSharedWorkbookRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DisableSharedWorkbookRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisableSharedWorkbookRequest input)
        {
            if (input == null)
                return false;
