...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HtmlToTextResponse :  IEquatable<HtmlToTextResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HtmlToTextResponse" /> class.
        /// </summary>
        /// <param name="successful">True if successful, false otherwise.</param>
        /// <param name="textContentResult">Text content result from the HTML input.</param>
        public HtmlToTextResponse(bool? successful = default(bool?), string textContentResult = default(string))
        {
        ...
        /// </summary>
        /// <value>Text content result from the HTML input</value>
        ...
        {
            return this.Equals(input as HtmlToTextResponse);
        }

        /// <summary>
        /// Returns true if HtmlToTextResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HtmlToTextResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HtmlToTextResponse input)
        {
            if (input == null)
                return false;
