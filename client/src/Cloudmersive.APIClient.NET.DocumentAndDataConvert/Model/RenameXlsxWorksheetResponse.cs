...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RenameXlsxWorksheetResponse :  IEquatable<RenameXlsxWorksheetResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenameXlsxWorksheetResponse" /> class.
        /// </summary>
        ...
        public RenameXlsxWorksheetResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as RenameXlsxWorksheetResponse);
        }

        /// <summary>
        /// Returns true if RenameXlsxWorksheetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RenameXlsxWorksheetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenameXlsxWorksheetResponse input)
        {
            if (input == null)
                return false;
