...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetXlsxImagesRequest :  IEquatable<GetXlsxImagesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXlsxImagesRequest" /> class.
        /// </summary>
        ...
        /// <param name="worksheetToQuery">Optional; Worksheet (tab) within the spreadsheet to get the images of; leave blank to default to the first worksheet.</param>
        public GetXlsxImagesRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string), XlsxWorksheet worksheetToQuery = default(XlsxWorksheet))
        {
        ...
        /// </summary>
        /// <value>Optional; Worksheet (tab) within the spreadsheet to get the images of; leave blank to default to the first worksheet</value>
        ...
        {
            return this.Equals(input as GetXlsxImagesRequest);
        }

        /// <summary>
        /// Returns true if GetXlsxImagesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXlsxImagesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXlsxImagesRequest input)
        {
            if (input == null)
                return false;
