...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetXlsxWorksheetsRequest :  IEquatable<GetXlsxWorksheetsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXlsxWorksheetsRequest" /> class.
        /// </summary>
        ...
        public GetXlsxWorksheetsRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetXlsxWorksheetsRequest);
        }

        /// <summary>
        /// Returns true if GetXlsxWorksheetsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXlsxWorksheetsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXlsxWorksheetsRequest input)
        {
            if (input == null)
                return false;
