...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeynoteToJpgResult :  IEquatable<KeynoteToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeynoteToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public KeynoteToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as KeynoteToJpgResult);
        }

        /// <summary>
        /// Returns true if KeynoteToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of KeynoteToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeynoteToJpgResult input)
        {
            if (input == null)
                return false;
