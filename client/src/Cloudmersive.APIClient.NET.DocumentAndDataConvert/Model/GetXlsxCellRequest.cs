...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetXlsxCellRequest :  IEquatable<GetXlsxCellRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>0-based index of the row, 0, 1, 2, ... to retrieve</value>
        ...
        /// </summary>
        /// <value>0-based index of the cell, 0, 1, 2, ... in the row to retrieve</value>
        ...
        {
            return this.Equals(input as GetXlsxCellRequest);
        }

        /// <summary>
        /// Returns true if GetXlsxCellRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXlsxCellRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXlsxCellRequest input)
        {
            if (input == null)
                return false;
