...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertDocxTablesResponse :  IEquatable<InsertDocxTablesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertDocxTablesResponse" /> class.
        /// </summary>
        ...
        public InsertDocxTablesResponse(bool? Successful = default(bool?), string EditedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as InsertDocxTablesResponse);
        }

        /// <summary>
        /// Returns true if InsertDocxTablesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertDocxTablesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertDocxTablesResponse input)
        {
            if (input == null)
                return false;
