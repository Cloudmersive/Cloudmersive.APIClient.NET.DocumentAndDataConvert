...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateDocxTableCellResponse :  IEquatable<UpdateDocxTableCellResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDocxTableCellResponse" /> class.
        /// </summary>
        ...
        public UpdateDocxTableCellResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateDocxTableCellResponse);
        }

        /// <summary>
        /// Returns true if UpdateDocxTableCellResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDocxTableCellResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDocxTableCellResponse input)
        {
            if (input == null)
                return false;
