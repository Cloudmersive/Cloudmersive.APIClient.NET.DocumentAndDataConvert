...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RtfToPngResult :  IEquatable<RtfToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RtfToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public RtfToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as RtfToPngResult);
        }

        /// <summary>
        /// Returns true if RtfToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RtfToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RtfToPngResult input)
        {
            if (input == null)
                return false;
