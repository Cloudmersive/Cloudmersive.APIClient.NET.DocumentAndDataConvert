...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OdsToPngResult :  IEquatable<OdsToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OdsToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public OdsToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as OdsToPngResult);
        }

        /// <summary>
        /// Returns true if OdsToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OdsToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OdsToPngResult input)
        {
            if (input == null)
                return false;
