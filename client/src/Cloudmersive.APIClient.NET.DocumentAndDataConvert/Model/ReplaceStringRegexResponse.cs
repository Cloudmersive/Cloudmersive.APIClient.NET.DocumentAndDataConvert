...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplaceStringRegexResponse :  IEquatable<ReplaceStringRegexResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceStringRegexResponse" /> class.
        /// </summary>
        /// <param name="successful">True if successful, false otherwise.</param>
        /// <param name="textContentResult">Result of performing a base 64 decode operation, binary file content.</param>
        public ReplaceStringRegexResponse(bool? successful = default(bool?), string textContentResult = default(string))
        {
        ...
        {
            return this.Equals(input as ReplaceStringRegexResponse);
        }

        /// <summary>
        /// Returns true if ReplaceStringRegexResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceStringRegexResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceStringRegexResponse input)
        {
            if (input == null)
                return false;
