...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetXlsxCellByIdentifierResponse :  IEquatable<SetXlsxCellByIdentifierResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetXlsxCellByIdentifierResponse" /> class.
        /// </summary>
        ...
        public SetXlsxCellByIdentifierResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as SetXlsxCellByIdentifierResponse);
        }

        /// <summary>
        /// Returns true if SetXlsxCellByIdentifierResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SetXlsxCellByIdentifierResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetXlsxCellByIdentifierResponse input)
        {
            if (input == null)
                return false;
