...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ZipExtractResponse :  IEquatable<ZipExtractResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ZipExtractResponse(bool? successful = default(bool?), List<ZipFile> filesInZip = default(List<ZipFile>), List<ZipDirectory> directoriesInZip = default(List<ZipDirectory>))
        {
        ...
        {
            return this.Equals(input as ZipExtractResponse);
        }

        /// <summary>
        /// Returns true if ZipExtractResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ZipExtractResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZipExtractResponse input)
        {
            if (input == null)
                return false;
