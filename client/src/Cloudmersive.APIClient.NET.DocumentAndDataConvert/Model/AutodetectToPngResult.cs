...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutodetectToPngResult :  IEquatable<AutodetectToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutodetectToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public AutodetectToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as AutodetectToPngResult);
        }

        /// <summary>
        /// Returns true if AutodetectToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AutodetectToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutodetectToPngResult input)
        {
            if (input == null)
                return false;
