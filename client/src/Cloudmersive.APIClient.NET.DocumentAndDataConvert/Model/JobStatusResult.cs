...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobStatusResult :  IEquatable<JobStatusResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="pptxResult">PowerPoint split result (if applicable).</param>
        /// <param name="errorMessage">Error message (if any).</param>
        public JobStatusResult(bool? successful = default(bool?), string asyncJobStatus = default(string), string asyncJobID = default(string), SplitPptxPresentationResult pptxResult = default(SplitPptxPresentationResult), string errorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>PowerPoint split result (if applicable)</value>
        [DataMember(Name="PptxResult", EmitDefaultValue=false)]
        public SplitPptxPresentationResult PptxResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PptxResult: ").Append(PptxResult).Append("\n");
        ...
        {
            return this.Equals(input as JobStatusResult);
        }

        /// <summary>
        /// Returns true if JobStatusResult instances are equal
        /// </summary>
        /// <param name="input">Instance of JobStatusResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobStatusResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PptxResult == input.PptxResult ||
                    (this.PptxResult != null &&
                    this.PptxResult.Equals(input.PptxResult))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PptxResult != null)
                    hashCode = hashCode * 59 + this.PptxResult.GetHashCode();
