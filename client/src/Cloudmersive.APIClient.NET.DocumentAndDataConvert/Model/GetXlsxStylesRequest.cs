...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetXlsxStylesRequest :  IEquatable<GetXlsxStylesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXlsxStylesRequest" /> class.
        /// </summary>
        ...
        public GetXlsxStylesRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetXlsxStylesRequest);
        }

        /// <summary>
        /// Returns true if GetXlsxStylesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXlsxStylesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXlsxStylesRequest input)
        {
            if (input == null)
                return false;
