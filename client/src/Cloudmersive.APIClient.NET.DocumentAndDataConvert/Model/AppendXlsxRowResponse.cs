...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppendXlsxRowResponse :  IEquatable<AppendXlsxRowResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppendXlsxRowResponse" /> class.
        /// </summary>
        ...
        public AppendXlsxRowResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as AppendXlsxRowResponse);
        }

        /// <summary>
        /// Returns true if AppendXlsxRowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AppendXlsxRowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppendXlsxRowResponse input)
        {
            if (input == null)
                return false;
