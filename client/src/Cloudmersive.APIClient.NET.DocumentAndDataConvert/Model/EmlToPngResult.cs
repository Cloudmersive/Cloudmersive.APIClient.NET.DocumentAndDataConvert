...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmlToPngResult :  IEquatable<EmlToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmlToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public EmlToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as EmlToPngResult);
        }

        /// <summary>
        /// Returns true if EmlToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of EmlToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmlToPngResult input)
        {
            if (input == null)
                return false;
