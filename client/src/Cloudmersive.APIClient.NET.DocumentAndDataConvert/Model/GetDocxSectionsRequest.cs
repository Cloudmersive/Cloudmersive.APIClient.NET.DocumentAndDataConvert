...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxSectionsRequest :  IEquatable<GetDocxSectionsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxSectionsRequest" /> class.
        /// </summary>
        ...
        public GetDocxSectionsRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetDocxSectionsRequest);
        }

        /// <summary>
        /// Returns true if GetDocxSectionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxSectionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxSectionsRequest input)
        {
            if (input == null)
                return false;
