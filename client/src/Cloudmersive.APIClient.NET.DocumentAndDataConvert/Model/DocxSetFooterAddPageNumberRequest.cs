...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocxSetFooterAddPageNumberRequest :  IEquatable<DocxSetFooterAddPageNumberRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DocxSetFooterAddPageNumberRequest);
        }

        /// <summary>
        /// Returns true if DocxSetFooterAddPageNumberRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DocxSetFooterAddPageNumberRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocxSetFooterAddPageNumberRequest input)
        {
            if (input == null)
                return false;
