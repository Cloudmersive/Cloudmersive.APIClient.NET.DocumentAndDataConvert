...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxContentControlsResponse :  IEquatable<GetDocxContentControlsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxContentControlsResponse" /> class.
        /// </summary>
        /// <param name="successful">True if successful, false otherwise.</param>
        /// <param name="contentControls">Content controls in the DOCX.</param>
        public GetDocxContentControlsResponse(bool? successful = default(bool?), List<DocxContentControl> contentControls = default(List<DocxContentControl>))
        {
        ...
        {
            return this.Equals(input as GetDocxContentControlsResponse);
        }

        /// <summary>
        /// Returns true if GetDocxContentControlsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxContentControlsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxContentControlsResponse input)
        {
            if (input == null)
                return false;
