...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConvertDocumentBatchJobCreateResult :  IEquatable<ConvertDocumentBatchJobCreateResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertDocumentBatchJobCreateResult" /> class.
        /// </summary>
        ...
        public ConvertDocumentBatchJobCreateResult(bool? successful = default(bool?), string asyncJobID = default(string))
        {
        ...
        {
            return this.Equals(input as ConvertDocumentBatchJobCreateResult);
        }

        /// <summary>
        /// Returns true if ConvertDocumentBatchJobCreateResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertDocumentBatchJobCreateResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertDocumentBatchJobCreateResult input)
        {
            if (input == null)
                return false;
