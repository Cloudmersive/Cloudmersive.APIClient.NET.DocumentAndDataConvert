...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OdtToJpgResult :  IEquatable<OdtToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OdtToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public OdtToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as OdtToJpgResult);
        }

        /// <summary>
        /// Returns true if OdtToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OdtToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OdtToJpgResult input)
        {
            if (input == null)
                return false;
