...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PdfToJpgResult :  IEquatable<PdfToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PdfToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public PdfToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as PdfToJpgResult);
        }

        /// <summary>
        /// Returns true if PdfToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PdfToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PdfToJpgResult input)
        {
            if (input == null)
                return false;
