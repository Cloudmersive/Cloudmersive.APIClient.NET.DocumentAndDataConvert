...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteDocxTableRowRangeResponse :  IEquatable<DeleteDocxTableRowRangeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDocxTableRowRangeResponse" /> class.
        /// </summary>
        ...
        public DeleteDocxTableRowRangeResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as DeleteDocxTableRowRangeResponse);
        }

        /// <summary>
        /// Returns true if DeleteDocxTableRowRangeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteDocxTableRowRangeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteDocxTableRowRangeResponse input)
        {
            if (input == null)
                return false;
