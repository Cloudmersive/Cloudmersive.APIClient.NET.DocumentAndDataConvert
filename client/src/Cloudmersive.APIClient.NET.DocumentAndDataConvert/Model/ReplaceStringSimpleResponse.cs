...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplaceStringSimpleResponse :  IEquatable<ReplaceStringSimpleResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceStringSimpleResponse" /> class.
        /// </summary>
        /// <param name="successful">True if successful, false otherwise.</param>
        /// <param name="textContentResult">Result of performing a replace string operation.</param>
        public ReplaceStringSimpleResponse(bool? successful = default(bool?), string textContentResult = default(string))
        {
        ...
        /// </summary>
        /// <value>Result of performing a replace string operation</value>
        ...
        {
            return this.Equals(input as ReplaceStringSimpleResponse);
        }

        /// <summary>
        /// Returns true if ReplaceStringSimpleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceStringSimpleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceStringSimpleResponse input)
        {
            if (input == null)
                return false;
