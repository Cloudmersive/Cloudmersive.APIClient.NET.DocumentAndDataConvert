...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OdsToJpgResult :  IEquatable<OdsToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OdsToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public OdsToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as OdsToJpgResult);
        }

        /// <summary>
        /// Returns true if OdsToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OdsToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OdsToJpgResult input)
        {
            if (input == null)
                return false;
