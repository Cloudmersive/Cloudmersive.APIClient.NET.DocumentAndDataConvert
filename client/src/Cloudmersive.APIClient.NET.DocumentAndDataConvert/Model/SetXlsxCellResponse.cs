...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetXlsxCellResponse :  IEquatable<SetXlsxCellResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetXlsxCellResponse" /> class.
        /// </summary>
        ...
        public SetXlsxCellResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as SetXlsxCellResponse);
        }

        /// <summary>
        /// Returns true if SetXlsxCellResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SetXlsxCellResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetXlsxCellResponse input)
        {
            if (input == null)
                return false;
