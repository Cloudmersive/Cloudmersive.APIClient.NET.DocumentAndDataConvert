...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxBodyResponse :  IEquatable<GetDocxBodyResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Body in the DOCX document</value>
        ...
        {
            return this.Equals(input as GetDocxBodyResponse);
        }

        /// <summary>
        /// Returns true if GetDocxBodyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxBodyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxBodyResponse input)
        {
            if (input == null)
                return false;
