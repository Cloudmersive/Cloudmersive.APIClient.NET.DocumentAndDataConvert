...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XmlSetValueWithXPathResult :  IEquatable<XmlSetValueWithXPathResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlSetValueWithXPathResult" /> class.
        /// </summary>
        ...
        public XmlSetValueWithXPathResult(bool? successful = default(bool?), string resultingXmlDocument = default(string), int? nodesEditedCount = default(int?))
        {
        ...
        {
            return this.Equals(input as XmlSetValueWithXPathResult);
        }

        /// <summary>
        /// Returns true if XmlSetValueWithXPathResult instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlSetValueWithXPathResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlSetValueWithXPathResult input)
        {
            if (input == null)
                return false;
