...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EditPdfBatchJobCreateResult :  IEquatable<EditPdfBatchJobCreateResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EditPdfBatchJobCreateResult" /> class.
        /// </summary>
        ...
        public EditPdfBatchJobCreateResult(bool? successful = default(bool?), string asyncJobID = default(string))
        {
        ...
        {
            return this.Equals(input as EditPdfBatchJobCreateResult);
        }

        /// <summary>
        /// Returns true if EditPdfBatchJobCreateResult instances are equal
        /// </summary>
        /// <param name="input">Instance of EditPdfBatchJobCreateResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditPdfBatchJobCreateResult input)
        {
            if (input == null)
                return false;
