...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PdfToPngDirectResult :  IEquatable<PdfToPngDirectResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PdfToPngDirectResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public PdfToPngDirectResult(bool? successful = default(bool?), List<ConvertedPngDirectPage> pngResultPages = default(List<ConvertedPngDirectPage>))
        {
        ...
        public List<ConvertedPngDirectPage> PngResultPages { get; set; }
        ...
        {
            return this.Equals(input as PdfToPngDirectResult);
        }

        /// <summary>
        /// Returns true if PdfToPngDirectResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PdfToPngDirectResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PdfToPngDirectResult input)
        {
            if (input == null)
                return false;
