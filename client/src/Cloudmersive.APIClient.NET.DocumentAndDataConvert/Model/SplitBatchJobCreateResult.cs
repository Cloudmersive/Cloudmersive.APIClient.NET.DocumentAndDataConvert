...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SplitBatchJobCreateResult :  IEquatable<SplitBatchJobCreateResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitBatchJobCreateResult" /> class.
        /// </summary>
        ...
        public SplitBatchJobCreateResult(bool? successful = default(bool?), string asyncJobID = default(string))
        {
        ...
        {
            return this.Equals(input as SplitBatchJobCreateResult);
        }

        /// <summary>
        /// Returns true if SplitBatchJobCreateResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SplitBatchJobCreateResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SplitBatchJobCreateResult input)
        {
            if (input == null)
                return false;
