...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetXlsxRowsAndCellsRequest :  IEquatable<GetXlsxRowsAndCellsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetXlsxRowsAndCellsRequest);
        }

        /// <summary>
        /// Returns true if GetXlsxRowsAndCellsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXlsxRowsAndCellsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXlsxRowsAndCellsRequest input)
        {
            if (input == null)
                return false;
