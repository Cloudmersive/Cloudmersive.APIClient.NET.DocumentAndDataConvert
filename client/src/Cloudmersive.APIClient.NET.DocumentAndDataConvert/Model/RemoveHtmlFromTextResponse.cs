...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveHtmlFromTextResponse :  IEquatable<RemoveHtmlFromTextResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveHtmlFromTextResponse" /> class.
        /// </summary>
        /// <param name="successful">True if successful, false otherwise.</param>
        /// <param name="textContentResult">Result of performing a remove HTML from string operation.</param>
        public RemoveHtmlFromTextResponse(bool? successful = default(bool?), string textContentResult = default(string))
        {
        ...
        /// </summary>
        /// <value>Result of performing a remove HTML from string operation</value>
        ...
        {
            return this.Equals(input as RemoveHtmlFromTextResponse);
        }

        /// <summary>
        /// Returns true if RemoveHtmlFromTextResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveHtmlFromTextResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveHtmlFromTextResponse input)
        {
            if (input == null)
                return false;
