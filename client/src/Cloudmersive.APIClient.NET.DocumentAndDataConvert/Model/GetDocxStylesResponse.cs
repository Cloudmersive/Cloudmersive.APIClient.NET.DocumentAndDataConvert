...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    public partial class GetDocxStylesResponse :  IEquatable<GetDocxStylesResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Styles in the DOCX document</value>
        ...
        {
            return this.Equals(input as GetDocxStylesResponse);
        }

        /// <summary>
        /// Returns true if GetDocxStylesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxStylesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxStylesResponse input)
        {
            if (input == null)
                return false;
