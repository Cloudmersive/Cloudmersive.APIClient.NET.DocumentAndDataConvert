...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocxSetHeaderResponse :  IEquatable<DocxSetHeaderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocxSetHeaderResponse" /> class.
        /// </summary>
        ...
        public DocxSetHeaderResponse(bool? Successful = default(bool?), string EditedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as DocxSetHeaderResponse);
        }

        /// <summary>
        /// Returns true if DocxSetHeaderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DocxSetHeaderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocxSetHeaderResponse input)
        {
            if (input == null)
                return false;
