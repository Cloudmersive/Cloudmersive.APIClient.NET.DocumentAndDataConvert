...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmlToJpgResult :  IEquatable<EmlToJpgResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmlToJpgResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="jpgResultPages">Array of converted pages.</param>
        public EmlToJpgResult(bool? successful = default(bool?), List<ConvertedJpgPage> jpgResultPages = default(List<ConvertedJpgPage>))
        {
        ...
        {
            return this.Equals(input as EmlToJpgResult);
        }

        /// <summary>
        /// Returns true if EmlToJpgResult instances are equal
        /// </summary>
        /// <param name="input">Instance of EmlToJpgResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmlToJpgResult input)
        {
            if (input == null)
                return false;
