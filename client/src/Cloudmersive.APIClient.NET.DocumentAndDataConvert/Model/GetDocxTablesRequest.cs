...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxTablesRequest :  IEquatable<GetDocxTablesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxTablesRequest" /> class.
        /// </summary>
        ...
        public GetDocxTablesRequest(byte[] InputFileBytes = default(byte[]), string InputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetDocxTablesRequest);
        }

        /// <summary>
        /// Returns true if GetDocxTablesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxTablesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxTablesRequest input)
        {
            if (input == null)
                return false;
