...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocxRemoveObjectResponse :  IEquatable<DocxRemoveObjectResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DocxRemoveObjectResponse);
        }

        /// <summary>
        /// Returns true if DocxRemoveObjectResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DocxRemoveObjectResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocxRemoveObjectResponse input)
        {
            if (input == null)
                return false;
