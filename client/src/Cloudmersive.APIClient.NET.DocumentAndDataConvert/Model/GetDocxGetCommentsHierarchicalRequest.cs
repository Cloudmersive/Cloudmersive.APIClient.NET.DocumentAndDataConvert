...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDocxGetCommentsHierarchicalRequest :  IEquatable<GetDocxGetCommentsHierarchicalRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDocxGetCommentsHierarchicalRequest" /> class.
        /// </summary>
        ...
        public GetDocxGetCommentsHierarchicalRequest(byte[] inputFileBytes = default(byte[]), string inputFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as GetDocxGetCommentsHierarchicalRequest);
        }

        /// <summary>
        /// Returns true if GetDocxGetCommentsHierarchicalRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDocxGetCommentsHierarchicalRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDocxGetCommentsHierarchicalRequest input)
        {
            if (input == null)
                return false;
