...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OdtToPngResult :  IEquatable<OdtToPngResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OdtToPngResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="pngResultPages">Array of converted pages.</param>
        public OdtToPngResult(bool? successful = default(bool?), List<ConvertedPngPage> pngResultPages = default(List<ConvertedPngPage>))
        {
        ...
        {
            return this.Equals(input as OdtToPngResult);
        }

        /// <summary>
        /// Returns true if OdtToPngResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OdtToPngResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OdtToPngResult input)
        {
            if (input == null)
                return false;
