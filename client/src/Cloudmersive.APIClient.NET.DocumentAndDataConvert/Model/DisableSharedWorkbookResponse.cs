...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DisableSharedWorkbookResponse :  IEquatable<DisableSharedWorkbookResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableSharedWorkbookResponse" /> class.
        /// </summary>
        ...
        public DisableSharedWorkbookResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as DisableSharedWorkbookResponse);
        }

        /// <summary>
        /// Returns true if DisableSharedWorkbookResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DisableSharedWorkbookResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisableSharedWorkbookResponse input)
        {
            if (input == null)
                return false;
