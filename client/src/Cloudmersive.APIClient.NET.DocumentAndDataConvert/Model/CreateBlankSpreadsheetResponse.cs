...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBlankSpreadsheetResponse :  IEquatable<CreateBlankSpreadsheetResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBlankSpreadsheetResponse" /> class.
        /// </summary>
        ...
        public CreateBlankSpreadsheetResponse(bool? successful = default(bool?), string editedDocumentURL = default(string))
        {
        ...
        {
            return this.Equals(input as CreateBlankSpreadsheetResponse);
        }

        /// <summary>
        /// Returns true if CreateBlankSpreadsheetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBlankSpreadsheetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBlankSpreadsheetResponse input)
        {
            if (input == null)
                return false;
