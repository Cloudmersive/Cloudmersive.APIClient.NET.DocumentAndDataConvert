...
namespace Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetXlsxCellByIdentifierResponse :  IEquatable<GetXlsxCellByIdentifierResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetXlsxCellByIdentifierResponse);
        }

        /// <summary>
        /// Returns true if GetXlsxCellByIdentifierResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXlsxCellByIdentifierResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXlsxCellByIdentifierResponse input)
        {
            if (input == null)
                return false;
