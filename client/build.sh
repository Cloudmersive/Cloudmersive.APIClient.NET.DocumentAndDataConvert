...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.DocumentAndDataConvert/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.DocumentAndDataConvert.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.DocumentAndDataConvert.dll \
-recurse:'src/Cloudmersive.APIClient.NET.DocumentAndDataConvert/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.DocumentAndDataConvert.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.DocumentAndDataConvert.dll was created successfully"
fi
