# Cloudmersive.APIClient.NET.DocumentAndDataConvert.Api.ConvertImageApi
...
namespace Example
{
    public class ConvertImageGetImageInfoExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling ConvertImageApi.ConvertImageGetImageInfo: " + e.Message );
            }
        }
    }
}
...
> MultipageImageFormatConversionResult ConvertImageMultipageImageFormatConvert (string format1, string format2, System.IO.Stream inputFile, int? dpi = null)
...
namespace Example
{
    public class ConvertImageMultipageImageFormatConvertExample
    {
        public void main()
        {
            // Configure API key authorization: Apikey
            ...
            {
                Debug.Print("Exception when calling ConvertImageApi.ConvertImageMultipageImageFormatConvert: " + e.Message );
            }
        }
    }
}
