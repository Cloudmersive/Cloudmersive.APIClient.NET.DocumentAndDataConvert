# Cloudmersive.APIClient.NET.DocumentAndDataConvert.Model.ScreenshotRequest
## Properties
...
**ScreenshotWidth** | **int?** | Optional: Width of the screenshot in pixels; supply 0 to default to 1280 x 1024 | [optional] 
